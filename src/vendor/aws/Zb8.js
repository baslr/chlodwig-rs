  var Zb8 = d(($e) => {
    ...
    class Wb8 {
      ...
      kind;
      values;
      constructor({ name: H, kind: _ = ZL$.FieldPosition.HEADER, values: q = [] }) {
    ...
    class nO_ {
      ...
      static clone(H) {
        let _ = new nO_({ ...H, headers: { ...H.headers } });
        if (_.query) _.query = vL$(_.query);
        return _;
      }
      static isInstance(H) {
        if (!H) return !1;
    ...
    $e.HttpRequest = nO_;
    $e.HttpResponse = Rb8;
    $e.getHttpHandlerExtensionConfiguration = LL$;
    $e.isValidHostname = NL$;
    $e.resolveHttpHandlerRuntimeConfig = kL$;
  });
