  var lm7 = d((FaH, mU6) => {
    (function (H, _) {
      ...
      else if (typeof FaH === "object") {
        if ((_(FaH), typeof mU6 === "object")) mU6.exports = q(FaH);
      } else
        (function () {
          var $ = {};
          _($), (H.Long = q($));
        })();
    })(typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : FaH, function (H) {
      ...
      if (
        ...
        (q.fromBigInt = function (C, g) {
          ...
          (q.fromValue = function (C, g) {
            if (typeof C === "bigint") return q.fromBigInt(C, g);
            return D(C, g);
          }),
          (I.toBigInt = function () {
