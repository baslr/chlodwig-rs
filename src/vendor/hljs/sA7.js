    ...
    function dH1(H) {
      let _ = {
        ...
        K = {
          ...
          keywords: "struct",
          contains: [{ className: "type", begin: H.UNDERSCORE_IDENT_RE, relevance: 0 }],
        },
        O = [
          {
            className: "params",
            ...
            endsWithParent: !0,
            relevance: 0,
            contains: [{ className: "literal", begin: /\.\.\./ }, H.C_NUMBER_MODE, H.C_BLOCK_COMMENT_MODE, q, K],
          },
        ],
        T = { className: "title", begin: H.UNDERSCORE_IDENT_RE, relevance: 0 },
        z = function (D, j, M) {
          let J = H.inherit(
            { className: "function", beginKeywords: D, end: j, excludeEnd: !0, contains: [].concat(O) },
            M || {},
          );
          return (
            J.contains.push(T),
            J.contains.push(H.C_NUMBER_MODE),
            J.contains.push(H.C_BLOCK_COMMENT_MODE),
            J.contains.push(q),
            J
          );
        },
        A = { className: "built_in", begin: "\\b(" + _.built_in.split(" ").join("|") + ")\\b" },
        f = { className: "string", begin: '"', end: '"', contains: [H.BACKSLASH_ESCAPE], relevance: 0 },
        w = {
          ...
          relevance: 0,
          contains: [
            { beginKeywords: _.keyword },
            A,
            { className: "built_in", begin: H.UNDERSCORE_IDENT_RE, relevance: 0 },
          ],
        },
        Y = {
          begin: /\(/,
          ...
          relevance: 0,
          keywords: { built_in: _.built_in, literal: _.literal },
          contains: [H.C_NUMBER_MODE, H.C_BLOCK_COMMENT_MODE, q, A, w, f, "self"],
        };
      return (
        w.contains.push(Y),
        {
          ...
          contains: [
            ...
            z("proc keyword", ";"),
            z("fn", "="),
            { beginKeywords: "for threadfor", end: /;/, relevance: 0, contains: [H.C_BLOCK_COMMENT_MODE, q, Y] },
            {
              variants: [
                { begin: H.UNDERSCORE_IDENT_RE + "\\." + H.UNDERSCORE_IDENT_RE },
                { begin: H.UNDERSCORE_IDENT_RE + "\\s*=" },
              ],
              relevance: 0,
            },
