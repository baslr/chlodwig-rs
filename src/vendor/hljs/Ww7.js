  var Ww7 = d((J8O, Xw7) => {
    function t_1(H) {
      let _ = {
        ...
        q = [H.C_BLOCK_COMMENT_MODE, H.HASH_COMMENT_MODE, H.COMMENT("--", "$"), H.COMMENT("[^:]//", "$")],
        $ = H.inherit(H.TITLE_MODE, {
          variants: [{ begin: "\\b_*rig[A-Z][A-Za-z0-9_\\-]*" }, { begin: "\\b_[a-z0-9\\-]+" }],
        }),
        K = H.inherit(H.TITLE_MODE, { begin: "\\b([A-Za-z0-9_\\-]+)\\b" });
      return {
        name: "LiveCode",
        case_insensitive: !1,
        keywords: {
        ...
        contains: [
          ...
          { className: "keyword", begin: "\\bend\\sif\\b" },
          {
            ...
            contains: [_, K, H.APOS_STRING_MODE, H.QUOTE_STRING_MODE, H.BINARY_NUMBER_MODE, H.C_NUMBER_MODE, $],
          },
          { className: "function", begin: "\\bend\\s+", end: "$", keywords: "end", contains: [K, $], relevance: 0 },
          {
