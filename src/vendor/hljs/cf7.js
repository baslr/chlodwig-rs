  var cf7 = d((_8O, df7) => {
    function Z_1(H) {
      let $ =
        ...
        T = "ADMINISTRATORS_GROUP_NAME CUSTOMIZERS_GROUP_NAME DEVELOPERS_GROUP_NAME SERVICE_USERS_GROUP_NAME ",
        z =
        ...
        w = "ENGLISH_LANGUAGE_CODE RUSSIAN_LANGUAGE_CODE ",
        Y = "smHidden smMaximized smMinimized smNormal wmNo wmYes ",
        D =
        ...
        j = "COMPONENT_TOKEN_LOCK_TYPE EDOCUMENT_VERSION_LOCK_TYPE ",
        M =
        ...
        X = "CURRENT_PERIOD_IS_REQUIRED PREVIOUS_CARD_TYPE_NAME SHOW_RECORD_PROPERTIES_FORM ",
        R =
        ...
        k = "CERTIFICATE_TYPE_ENCRYPT CERTIFICATE_TYPE_SIGN CERTIFICATE_TYPE_SIGN_AND_ENCRYPT ",
        v = "STORAGE_TYPE_FILE STORAGE_TYPE_NAS_CIFS STORAGE_TYPE_SAPERION STORAGE_TYPE_SQL_SERVER ",
        y =
        ...
        p = "SYSCOMP_CONTROL_JOBS SYSCOMP_FOLDERS SYSCOMP_JOBS SYSCOMP_NOTICES SYSCOMP_TASKS ",
        C =
        ...
        c = "ACCESS_RIGHTS_TABLE_NAME EDMS_ACCESS_TABLE_NAME EDOC_TYPES_TABLE_NAME ",
        U =
        ...
        _H = "EDOC_VERSION_ACTIVE_STAGE_CODE EDOC_VERSION_DESIGN_STAGE_CODE EDOC_VERSION_OBSOLETE_STAGE_CODE ",
        HH =
        ...
        e = "ISBL_SYNTAX NO_SYNTAX XML_SYNTAX ",
        qH =
        ...
        $H =
          K +
          "CR FALSE nil NO_VALUE NULL TAB TRUE YES_VALUE ADMINISTRATORS_GROUP_NAME CUSTOMIZERS_GROUP_NAME DEVELOPERS_GROUP_NAME SERVICE_USERS_GROUP_NAME " +
          z +
          A +
          f +
          "ENGLISH_LANGUAGE_CODE RUSSIAN_LANGUAGE_CODE smHidden smMaximized smMinimized smNormal wmNo wmYes " +
          D +
          ...
          qH +
          r,
        DH = "atUser atGroup atRole ",
        fH = "aemEnabledAlways aemDisabledAlways aemEnabledOnBrowse aemEnabledOnEdit aemDisabledOnBrowseEmpty ",
        vH = "apBegin apEnd ",
        KH = "alLeft alRight ",
        n = "asmNever asmNoButCustomize asmAsLastTime asmYesButCustomize asmAlways ",
        l = "cirCommon cirRevoked ",
        a = "ctSignature ctEncode ctSignatureEncode ",
        t = "clbUnchecked clbChecked clbGrayed ",
        s = "ceISB ceAlways ceNever ",
        OH =
        ...
        XH = "cfInternal cfDisplay ",
        jH = "ciUnspecified ciWrite ciRead ",
        GH = "ckFolder ckEDocument ckTask ckJob ckComponentToken ckAny ckReference ckScript ckReport ckDialog ",
        RH =
        ...
        NH = "cctDate cctInteger cctNumeric cctPick cctReference cctString cctText ",
        hH = "cltInternal cltPrimary cltGUI ",
        ZH =
        ...
        bH = "dssEdit dssInsert dssBrowse dssInActive ",
        nH = "dftDate dftShortDate dftDateTime dftTimeStamp ",
        __ = "dotDays dotHours dotMinutes dotSeconds ",
        SH = "dtkndLocal dtkndUTC ",
        VH = "arNone arView arEdit arFull ",
        yH = "ddaView ddaEdit ",
        sH =
        ...
        zH = "ecotFile ecotProcess ",
        WH = "eaGet eaCopy eaCreate eaCreateStandardRoute ",
        BH = "edltAll edltNothing edltQuery ",
        EH = "essmText essmCard ",
        mH = "esvtLast esvtLastActive esvtSpecified ",
        FH = "edsfExecutive edsfArchive ",
        TH = "edstSQLServer edstFile ",
        wH = "edvstNone edvstEDocumentVersionCopy edvstFile edvstTemplate edvstScannedFile ",
        dH = "vsDefault vsDesign vsActive vsObsolete ",
        JH = "etNone etCertificate etPassword etCertificatePassword ",
        LH = "ecException ecWarning ecInformation ",
        xH = "estAll estApprovingOnly ",
        tH = "evtLast evtLastActive evtQuery ",
        D_ = "fdtString fdtNumeric fdtInteger fdtDate fdtText fdtUnknown fdtWideString fdtLargeInteger ",
        w_ =
          "ftInbox ftOutbox ftFavorites ftCommonFolder ftUserFolder ftComponents ftQuickLaunch ftShortcuts ftSearch ",
        y_ = "grhAuto grhX1 grhX2 grhX3 ",
        O6 = "hltText hltRTF hltHTML ",
        l_ = "iffBMP iffJPEG iffMultiPageTIFF iffSinglePageTIFF iffTIFF iffPNG ",
        f8 = "im8bGrayscale im24bRGB im1bMonochrome ",
        x6 = "itBMP itJPEG itWMF itPNG ",
        L6 = "ikhInformation ikhWarning ikhError ikhNoIcon ",
        z8 =
        ...
        Oq = "isShow isHide isByUserSettings ",
        iq = "jkJob jkNotice jkControlJob ",
        X9 = "jtInner jtLeft jtRight jtFull jtCross ",
        S8 = "lbpAbove lbpBelow lbpLeft lbpRight ",
        Dq = "eltPerConnection eltPerUser ",
        f4 = "sfcUndefined sfcBlack sfcGreen sfcRed sfcBlue sfcOrange sfcLilac ",
        j1 = "sfsItalic sfsStrikeout sfsNormal ",
        w4 =
        ...
        t3 = "mrcrtNone mrcrtUser mrcrtMaximal mrcrtCustom ",
        I3 = "vtEqual vtGreaterOrEqual vtLessOrEqual vtRange ",
        P5 =
          "rdYesterday rdToday rdTomorrow rdThisWeek rdThisMonth rdThisYear rdNextMonth rdNextWeek rdLastWeek rdLastMonth ",
        c4 = "rdWindow rdFile rdPrinter ",
        vO =
          "rdtString rdtNumeric rdtInteger rdtDate rdtReference rdtAccount rdtText rdtPick rdtUnknown rdtLargeInteger rdtDocument ",
        W9 = "reOnChange reOnChangeValues ",
        v$ = "ttGlobal ttLocal ttUser ttSystem ",
        u3 = "ssmBrowse ssmSelect ssmMultiSelect ssmBrowseModal ",
        eO = "smSelect smLike smCard ",
        X5 = "stNone stAuthenticating stApproving ",
        r9 = "sctString sctStream ",
        e3 = "sstAnsiSort sstNaturalSort ",
        P8 = "svtEqual svtContain ",
        vK =
        ...
        hT = "tarAbortByUser tarAbortByWorkflowException ",
        Y4 = "tvtAllWords tvtExactPhrase tvtAnyWord ",
        yT =
          "usNone usCompleted usRedSquare usBlueSquare usYellowSquare usGreenSquare usOrangeSquare usPurpleSquare usFollowUp ",
        HO = "utUnknown utUser utDeveloper utAdministrator utSystemDeveloper utDisconnected ",
        N4 = "btAnd btDetailAnd btOr btNotOr btOnly ",
        o$ = "vmView vmSelect vmNavigation ",
        Hw = "vsmSingle vsmMultiple vsmMultipleCheck vsmNoSelection ",
        _w = "wfatPrevious wfatNext wfatCancel wfatFinish ",
        h4 =
        ...
        hA = "wfetQueryParameter wfetText wfetDelimiter wfetLabel ",
        sT =
        ...
        yz = "wsrComplete wsrGoNext wsrGoPrevious wsrCustom wsrCancel wsrGoFinal ",
        i7 = "wstForm wstEDocument wstTaskCard wstReferenceRecordCard wstFinal ",
        B5 = "waAll waPerformers waManual ",
        M1 =
        ...
        Vz = "wiLow wiNormal wiHigh ",
        _O = "wrtSoft wrtHard ",
        J1 = "wsInit wsRunning wsDone wsControlled wsAborted wsContinued ",
        NO = "wtmFull wtmFromCurrent wtmOnlyCurrent ",
        W5 =
          "atUser atGroup atRole " +
          fH +
          "apBegin apEnd alLeft alRight " +
          n +
          "cirCommon cirRevoked ctSignature ctEncode ctSignatureEncode clbUnchecked clbChecked clbGrayed ceISB ceAlways ceNever " +
          OH +
          "cfInternal cfDisplay ciUnspecified ciWrite ciRead " +
          GH +
          RH +
          NH +
          "cltInternal cltPrimary cltGUI " +
          ZH +
          "dssEdit dssInsert dssBrowse dssInActive dftDate dftShortDate dftDateTime dftTimeStamp dotDays dotHours dotMinutes dotSeconds dtkndLocal dtkndUTC arNone arView arEdit arFull ddaView ddaEdit " +
          sH +
          "ecotFile ecotProcess eaGet eaCopy eaCreate eaCreateStandardRoute edltAll edltNothing edltQuery essmText essmCard esvtLast esvtLastActive esvtSpecified edsfExecutive edsfArchive edstSQLServer edstFile edvstNone edvstEDocumentVersionCopy edvstFile edvstTemplate edvstScannedFile vsDefault vsDesign vsActive vsObsolete etNone etCertificate etPassword etCertificatePassword ecException ecWarning ecInformation estAll estApprovingOnly evtLast evtLastActive evtQuery " +
          D_ +
          w_ +
          y_ +
          O6 +
        ...
        _D = $H + W5,
        $2 = g5,
        Sz = "null true false nil ",
        x3 = { className: "number", begin: H.NUMBER_RE, relevance: 0 },
        ST = {
          className: "string",
          variants: [
            { begin: '"', end: '"' },
        ...
        M6 = { className: "doctag", begin: "\\b(?:TODO|DONE|BEGIN|END|STUB|CHG|FIXME|NOTE|BUG|XXX)\\b", relevance: 0 },
        i8 = { className: "comment", begin: "//", end: "$", relevance: 0, contains: [H.PHRASAL_WORDS_MODE, M6] },
        Y7 = { className: "comment", begin: "/\\*", end: "\\*/", relevance: 0, contains: [H.PHRASAL_WORDS_MODE, M6] },
        r8 = { variants: [i8, Y7] },
        jq = {
          $pattern:
        ...
        O9 = { begin: "\\.\\s*" + H.UNDERSCORE_IDENT_RE, keywords: jq, relevance: 0 },
        I$ = {
          className: "type",
          begin: ":[ \\t]*(" + VT.trim().replace(/\s/g, "|") + ")",
          end: "[ \\t]*=",
          excludeEnd: !0,
        },
        o7 = {
