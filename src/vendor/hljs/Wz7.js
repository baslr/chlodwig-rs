  var Wz7 = d((i_O, Xz7) => {
    ...
    function Ze4(H) {
      let _ = H.COMMENT("//", "$", { contains: [{ begin: /\\\n/ }] }),
        ...
        $ = "[a-zA-Z_]\\w*::",
        K = "<[^<>]+>",
        O = "(decltype\\(auto\\)|" + PN_("[a-zA-Z_]\\w*::") + "[a-zA-Z_]\\w*" + PN_("<[^<>]+>") + ")",
        ...
        Y = { className: "title", begin: PN_("[a-zA-Z_]\\w*::") + H.IDENT_RE, relevance: 0 },
        D = PN_("[a-zA-Z_]\\w*::") + H.IDENT_RE + "\\s*\\(",
        M = {
          keyword:
        ...
        J = {
          ...
          relevance: 0,
          keywords: M,
          begin: $u6(/\b/, /(?!decltype)/, /(?!if)/, /(?!for)/, /(?!while)/, H.IDENT_RE, Re4(/\s*\(/)),
        },
    ...
    function Le4(H) {
      ...
      if (((_.disableAutodetect = !0), (_.aliases = []), !H.getLanguage("c"))) _.aliases.push(...q);
      if (!H.getLanguage("cpp")) _.aliases.push(...$);
      return _;
    }
    Xz7.exports = Le4;
  });
