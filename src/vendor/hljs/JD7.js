  var JD7 = d((YqO, MD7) => {
    function w81(H) {
      let T = { className: "variable", variants: [{ begin: /\$[\w\d#@][\w\d_]*/ }, { begin: /\$\{(.*?)\}/ }] },
        z = {
          className: "string",
          begin: /"/,
          end: /"/,
          contains: [
            H.BACKSLASH_ESCAPE,
            T,
            { className: "variable", begin: /\$\(/, end: /\)/, contains: [H.BACKSLASH_ESCAPE] },
          ],
        },
      ...
      return {
        ...
        keywords: {
          ...
          keyword:
            ...
            "foreach do while for if from to step else on-error and or not in".split(" ").join(" :") +
            " :" +
