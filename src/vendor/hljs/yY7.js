  var yY7 = d((Q8O, hY7) => {
    function m61(H) {
      ...
      return {
        ...
        case_insensitive: !0,
        keywords: { keyword: O + z + T, built_in: w + Y + D },
        ...
        contains: [
          ...
          { begin: "\\b(" + M + ")\\s*\\(" },
          { begin: "\\.(" + f + ")\\b" },
          { begin: "\\b(" + f + ")\\s+PATH\\b", keywords: { keyword: "PATH", type: A.replace("PATH ", "") } },
          { className: "type", begin: "\\b(" + f + ")\\b" },
          ...
          { className: "symbol", begin: K, relevance: 10 },
        ],
      };
    }
    hY7.exports = m61;
