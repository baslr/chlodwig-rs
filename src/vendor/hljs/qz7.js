  var qz7 = d((B_O, _z7) => {
    function fe4(H) {
      let _ =
        ...
        $ = "True False And Null Not Or Default",
        K =
        ...
        O = {
          variants: [
            ...
            H.COMMENT("#cs", "#ce"),
            H.COMMENT("#comments-start", "#comments-end"),
          ],
        },
        T = { begin: "\\$[A-z0-9_]+" },
        z = {
        ...
        A = { variants: [H.BINARY_NUMBER_MODE, H.C_NUMBER_MODE] },
        f = {
          className: "meta",
          begin: "#",
          end: "$",
          keywords: { "meta-keyword": q },
          contains: [
            { begin: /\\\n/, relevance: 0 },
            {
        ...
        w = { className: "symbol", begin: "@[A-z0-9_]+" },
        Y = {
          className: "function",
          beginKeywords: "Func",
          end: "$",
          illegal: "\\$|\\[|%",
          contains: [H.UNDERSCORE_TITLE_MODE, { className: "params", begin: "\\(", end: "\\)", contains: [T, z, A] }],
        };
      return {
        name: "AutoIt",
        case_insensitive: !0,
