    OPK = [
      ...
      { pattern: /\bgit\s+stash\s+(drop|clear)\b/i, warning: "Note: may permanently remove stashed changes" },
      {
      ...
      { pattern: /\bClear-RecycleBin\b/i, warning: "Note: permanently deletes recycled files" },
    ];
