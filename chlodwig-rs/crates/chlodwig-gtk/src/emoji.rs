...
mod tests {
    ...
    fn test_monospace_emoji_width() {
        assert_eq!(super::monospace_emoji_width(8), 16);
        assert_eq!(super::monospace_emoji_width(7), 14);
        assert_eq!(super::monospace_emoji_width(10), 20);
    }

    #[test]
    fn test_monospace_emoji_width_zero_returns_zero() {
        // Edge case: if mono_char_width is 0 (shouldn't happen, but defensive)
        assert_eq!(super::monospace_emoji_width(0), 0);
    }
    ...
    fn test_monospace_emoji_width_is_exact_not_max() {
        ...
        let mono_w = 8;
        let target = super::monospace_emoji_width(mono_w); // 16
        assert_eq!(target, 16);
